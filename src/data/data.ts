export const data = {
  ...
  pricingSection: {
    ...
    subHeading:
      "— Simple pricing that makes sense for your business. No hidden fees.", // "We build websites that drive results and help your business grow. No Calls. No BS. Just Results." //"— As a tight-knit team of experts, we create memorable and emotional websites, digital experiences, and native apps"; //`— Creating cool experiences is our thing!`;
    pricing: {
      packageA: {
        heading: "Components",
        subHeading:
