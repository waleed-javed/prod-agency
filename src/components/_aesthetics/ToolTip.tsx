      ...
      {items.map((item, idx) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative !m-0 h-12 w-12 rounded-full border-2 border-white object-cover object-top !p-0 transition  duration-500 group-hover:z-30 group-hover:scale-105 md:h-14 md:w-14"
          />
        </div>
      ))}
    </div>
