...
const CallToActionButtonSmall = ({ btnText, handleOnClick }) => {
  return (
    <>
      ...
      >
        <div className="poppins-semibold group relative z-10 flex h-10 items-center space-x-2 rounded-full bg-zinc-950 px-1.5 py-1 text-xs ring-1 ring-white/10 hover:drop-shadow-md md:px-4 md:py-3 ">
          <span>{btnText}</span>
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 flex items-center space-x-2 rounded-full bg-zinc-950  px-2 py-1 text-xs ring-1 ring-white/10 md:px-4 md:py-3 md:text-lg lg:text-xl ">
          <span>{btnText}</span>
